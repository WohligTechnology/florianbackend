...
<div class="row">
			<div class="file-field input-field col m6 s12">
				<span class="img-center big">
								                    	<?php if($before->image == "") { } else {
									                    ?><img src="<?php echo base_url('uploads')."/".$before->mobile_image; ?>">
															<?php } ?>
															</span>
				<div class="btn blue darken-4">
				...
				<div class="file-path-wrapper">
					<input class="file-path validate" type="text" placeholder="Upload one or more files" value="<?php echo set_value('mobile_image',$before->mobile_image);?>">
				</div>
			</div>
      <span style=" display: block;
